...
{
	int						X ;								// スティック0のＸ軸パラメータ( -1000～1000 )
	int						Y ;								// スティック0のＹ軸パラメータ( -1000～1000 )
	int						Z ;								// スティック0のＺ軸パラメータ( -1000～1000 )
	int						Rx ;							// スティック1のＸ軸パラメータ( -1000～1000 )
	int						Ry ;							// スティック1のＹ軸パラメータ( -1000～1000 )
	int						Rz ;							// スティック1のＺ軸パラメータ( -1000～1000 )
...
extern	int			GetJoypadDirectInputState( int InputType, DINPUT_JOYSTATE *DInputState ) ;	// DirectInput から得られるジョイパッドの生のデータを取得する( DX_CHECKINPUT_KEY や DX_INPUT_KEY_PAD1 を引数に渡すとエラー )
